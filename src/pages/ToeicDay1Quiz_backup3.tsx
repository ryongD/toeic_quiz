...
function QuizSection({ title, questions, type, userAnswers, setUserAnswers, submitted }) {
    ...
    <div>
      ...
      {questions.map((q, index) => (
        <div key={index} style={{ marginBottom: "20px" }}>
          <p>
            {type === "fill"
              ? `Q${index + 1}. ${q.translation} → ${q.question.replace("___", "_____")}`
              : type === "idiom"
                ...
                <li key={i} style={{ margin: "4px 0" }}>
                  <label>
                    ...
                    {submitted && choice === q.answer && (
                      <span style={{ color: "green", marginLeft: "10px" }}>← 정답</span>
                    )}
                  </label>
                </li>
              ))}
