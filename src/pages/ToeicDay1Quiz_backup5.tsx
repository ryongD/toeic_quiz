  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-12">
      ...
      <section className="bg-white shadow-md rounded-xl p-6">
        ...
        {fillInBlank.map((q, i) => (
          <div key={i} className="mb-6">
            <p className="font-medium">{i + 1}. {q.translation}</p>
      ...
      <section className="bg-white shadow-md rounded-xl p-6">
        ...
        {idioms.map((q, i) => (
          <div key={i} className="mb-6">
            <p className="font-medium mb-2">{i + 1}. "{q.translation}" 에 해당하는 숙어는?</p>
            <div className="space-y-2">
              {q.choices.map((choice, j) => (
                <label key={j} className="block">
                  <input
      ...
      {submitted && (
        <div className="mt-10 text-center text-lg font-bold text-green-700">
